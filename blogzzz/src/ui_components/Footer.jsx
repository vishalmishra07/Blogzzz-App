    ...
    <div className="flex max-lg:gap-9 lg:gap-4 flex-wrap max-md:justify-center justify-between">
      ...
      <div className="text-[#181A2A] text-[14px] flex flex-col gap-4 px-4 max-md:items-center">
        ...
        <ul className="flex flex-col gap-4   text-[#3B3C4A] max-md:items-center dark:text-[#97989F]">
          <li className="hover:text-gray-600 hover:font-bold hover:text-xl hover:translate-x-3 translation ease-in-out transition-all hover:animate-vibrate">Home</li>
          <li  className="hover:text-gray-500 hover:font-bold hover:text-xl hover:translate-x-3 translation ease-in-out transition-all">About</li>
          <li  className="hover:text-gray-600 hover:font-bold hover:text-xl hover:translate-x-3 translation ease-in-out transition-all">Blog</li>
          <li  className="hover:text-gray-600 hover:font-bold hover:text-xl hover:translate-x-3 translation ease-in-out transition-all">Archived</li>
          <li  className="hover:text-gray-600 hover:font-bold hover:text-xl hover:translate-x-3 translation ease-in-out transition-all">Author</li>
          <li  className="hover:text-gray-600 hover:font-bold hover:text-xl hover:translate-x-3 translation ease-in-out transition-all">Contact</li>
        </ul>
      </div>
